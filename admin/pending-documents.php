...
<html lang="en">
<head>
    <title>Admin |Pending Documents</title>
            ...
            <div class="box">
                ...
                <div class="box-body no-padding">
                    <table class="table table-striped table-condensed">
                        ...
                        <tbody>
                        <?php $result = $document->getPendingDocuments();
                        if($result != ""){
                            $x = 0;
                            foreach ($result as $row) {
                                $document->setDocument($row['id']);
//                                $dean->setCollegeDean($college->getId());
//                                $member->setMember($dean->getMemberId());
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="<?php echo DOCUMENT_UPLOAD. $document->getDocumentName();?>"
                                            class="btn btn-primary glyphicon glyphicon-remove-circle"
                    ...
                    <div class="pagination-nav d-flex justify-content-center">
                        <ul class="pagination">
                            ...
                            for($i = 1; $i <= $count; $i++) {
                                ...
                                if($i == $page){
                                    echo "<li class=\"active\"><a href=\"pending-documents.php?page={$i}\">{$i}</a></li>";
                                }else {
                                    echo "<li><a href=\"pending-documents.php?page={$i}\">{$i}</a></li>";
                                }
                            }
                            ?>
                            <li><a href="#">»</a></li>
